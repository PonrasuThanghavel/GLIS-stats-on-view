...
const Landview = () => {
    ...
    const fetchLandData = async () => {
        try {
            const response = await axios.get("https://glis-stats-on-view.onrender.com/api/agri/fetch");
    ...
    const handleDelete = async (id) => {
        try {
            setLoading(true);
            const response = await axios.delete(`https://glis-stats-on-view.onrender.com/api/agri/delete/${id}`);
